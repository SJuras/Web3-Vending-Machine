...
export default function Home() {
  return (
    <div className="bg-brendanWhite">
      ...
      <a href="https://metamask.io/" className="font-Ubuntu">metamask.io</a>
      <p className="font-Ubuntu">
        First, let's get you some test Ether. <br />
        You can get that from one of testnet Rinkeby faucets:
      </p>
      <ul>
        <li><a href="https://faucet.rinkeby.io/" className="font-Ubuntu">faucet.rinkeby.io</a></li>
        <li><a href="https://rinkeby.faucet.epirus.io/" className="font-Ubuntu">rinkeby.faucet.epirus.io</a></li>
        <li><a href="https://faucets.chain.link/rinkeby" className="font-Ubuntu">faucets.chain.link/rinkeby</a></li>
      </ul>
      <p className="font-Ubuntu">
